 ...
 * Generated for Laravel 5.0.16 on 2015-05-25.
 *
...
namespace {
    ...
    class Est extends \EstTools\EstFacades{
         ...
         * @static 
         */
        public static function GetIntake($part, $date = null){
            return \EstTools\Est::GetIntake($part, $date);
        }
